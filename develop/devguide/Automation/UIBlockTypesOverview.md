...
> - From DataMiner 10.6.3/10.6.0 onwards <!-- RN 44515 / 44541 --> when updating the UI the previous collapsed state of the tree view nodes can be restored. Set the [UsePreviousCollapsedState](xref:Skyline.DataMiner.Net.AutomationUI.Objects.TreeViewItem.UsePreviousCollapsedState) to true to restore the state. If no prior state is available, the value of [IsCollapsed](xref:Skyline.DataMiner.Net.AutomationUI.Objects.TreeViewItem.IsCollapsed) will be used instead.
